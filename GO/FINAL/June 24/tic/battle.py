...
# 15 is eps, 16 = stochastic, 17 = greedy deterministic
w1 = np.load('weights'+str(one)+'.npy', allow_pickle= True)
model1.set_weights(w1)

w2 = np.load('weights'+str(two)+'.npy', allow_pickle= True)
...
# Let this model always take random moves
...
print("total wins by model 1 is  "+ str(wins1) +"  and model 2 is "+ str(wins2))