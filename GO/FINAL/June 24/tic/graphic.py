...
folder = "C:\\Users\\Aditya Prasad\\OneDrive - Indian Institute of Science\\Documents\\IISc\\Semester 2\\Robot\\Project\\GO\\FINAL\\June 24\\tic"
x_padding = 400
y_padding = 400
...
def go(state_in_string, turn = 0,  points = [-2,-2], pos = -1, player = -1, plot = False):
    #sanity check
    ...
    output = cv2.putText(output, "BLACK HAS " + str(points[2]) + " POINTS", (60,160), cv2.FONT_HERSHEY_SIMPLEX,  
                   3, (0, 0, 0), 10, cv2.LINE_AA)
    output = cv2.putText(output, "Player " + str(player) + " @ pos "+str(pos), (pm.board_pixel-500,360), cv2.FONT_HERSHEY_SIMPLEX,  
                   3, (0, 0, 0), 10, cv2.LINE_AA)
